...
1. If you are using a self-signed certificate with mattermost running over `https`, you must enable `Disable certificate verification` system console setting 
