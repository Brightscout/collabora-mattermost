...
interface ComponentProps {
    fileInfo: FileInfo;
    post: Post;
    wopiFiles: Record<string, unknown>;
}
...
//
//
// class WopiFilePreview extends React.Component<ComponentProps> {
//     componentDidUpdate(prevProps: ComponentProps) {
//         const {fileInfo} = this.props;
//         if (fileInfo?.id && fileInfo.id !== prevProps.fileInfo?.id) {
//             this.handleWopiFile(fileInfo.id);
//         }
//     }
//
//     handleWopiFile = async (fileID: string) => {
//         //ask the server for the Collabora Online URL & token where the file will be edited
//         //and load it into the iframe
//         const fileData = await Client.getCollaboraOnlineURL(fileID);
//
